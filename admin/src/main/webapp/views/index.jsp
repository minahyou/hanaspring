...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <c:choose>
                            <c:when test="${id == null}">
                                <a href="#" data-toggle="modal" data-target="#logoinModal">login</a>
                            </c:when>
                            <c:otherwise>
    ...
    <!-- Login Modal 위치 어디에 둬도 상관없음-->
    <div class="modal fade" id="logoinModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel"
         aria-hidden="true">
