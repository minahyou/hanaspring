...
<head>
    ...
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1"> <!--반응형 레이아웃 -->
    ...
    <!-- Kakao Map API -->
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ee4586402a3a2848cde9245cc50c4be3"></script>
    <style>
        .fakeimg {
            height: 200px;
            background: #aaa;
...
<c:choose>
    <c:when test="${id == null}"> <!--session정보가져오기-->
